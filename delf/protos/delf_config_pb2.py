...
_DELFLOCALFEATURECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_resized_coordinates', full_name='delf.protos.DelfLocalFeatureConfig.use_resized_coordinates', index=6,
...
_DELFGLOBALFEATURECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='use_pca', full_name='delf.protos.DelfGlobalFeatureConfig.use_pca', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pca_parameters', full_name='delf.protos.DelfGlobalFeatureConfig.pca_parameters', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_scales_ind', full_name='delf.protos.DelfGlobalFeatureConfig.image_scales_ind', index=2,
...
_DELFCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='use_local_features', full_name='delf.protos.DelfConfig.use_local_features', index=0,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='delf_local_config', full_name='delf.protos.DelfConfig.delf_local_config', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_global_features', full_name='delf.protos.DelfConfig.use_global_features', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='delf_global_config', full_name='delf.protos.DelfConfig.delf_global_config', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='model_path', full_name='delf.protos.DelfConfig.model_path', index=4,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='is_tf2_exported', full_name='delf.protos.DelfConfig.is_tf2_exported', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_scales', full_name='delf.protos.DelfConfig.image_scales', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_image_size', full_name='delf.protos.DelfConfig.max_image_size', index=7,
      number=4, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_image_size', full_name='delf.protos.DelfConfig.min_image_size', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_square_images', full_name='delf.protos.DelfConfig.use_square_images', index=9,
...
DelfGlobalFeatureConfig = _reflection.GeneratedProtocolMessageType('DelfGlobalFeatureConfig', (_message.Message,), dict(
